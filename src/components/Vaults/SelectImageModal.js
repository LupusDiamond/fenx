        ...
        return (
          <div className={`absolute w-full h-full bg-white p-6 flex flex-col md:flex-row ${this.showModal()}`}>
            ...
            <div className="w-full md:max-w-xs mb-4 md:mb-0">
              ...
              <form className="w-full flex h-auto">
                ...
                <div onClick={() => this.onSubmitClick()} className="w-12 h-12 bg-gray-900 relative flex-shrink-0 flex items-center justify-center rounded-tr-md rounded-br-md">
                  ...
                  <input  className="w-full h-full absolute top-0 left-0 bg-gray-900  bg-opacity-0 focus:outline-none focus:shadow-outline rounded-tr-md rounded-br-md" />
                </div>
              </form>
            </div>
            {/* Images */}
            <div className="w-full md:ml-6 flex flex-col md:grid grid-cols-2 gap-4 overflow-y-scroll">
              {this.renderImages()}
            </div>
          </div>
        )
